...
const Footer = () => {
    return (
        ...
        <footer className="footer footer-center p-10 bg-slate-300 mt-10">
            <div>
                <Link to='/' className=" normal-case text-xl font-bold w-40 h-20">
                    <img src={logo} alt="" />
                </Link>
                <p className="font-bold">
                    Top Gear Industries Ltd. <br />Providing reliable Toy Car since 1992
                </p>
                <p>Copyright © Top Gear 2023 - All right reserved</p>
            </div>
            <div>
